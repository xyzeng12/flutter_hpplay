...
fun logD(msg: String?) {
    val message = formatMessage(msg)
    if (!inProduction) Log.d(TAG, message)
}

fun logI(msg: String?) {
    val message = formatMessage(msg)
    if (!inProduction) Log.i(TAG, message)
}

fun logW(msg: String?) {
    val message = formatMessage(msg)
    if (!inProduction) Log.w(TAG, message)
}

fun logW(msg: String?, tr: Throwable?) {
    val message = formatMessage(msg)
    if (!inProduction) Log.w(TAG, message, tr)
}
...
fun logE(msg: String?) {
    val message = formatMessage(msg)
    if (!inProduction) Log.e(TAG, message)
}

fun logE(msg: String?, tr: Throwable?) {
    val message = formatMessage(msg)
    if (!inProduction) Log.e(TAG, message, tr)
}
